  ...
  const handleDeletePermission = async () => {
    ...
    try {
      const response = await fetch(
        `http://localhost:8080/permissions/${deletePermissionName}`,
        {
          method: "DELETE",
          headers: {
            "Content-Type": "application/json",
      ...
      showSuccess(`Permission ${deletePermissionName} deleted successfully`);
          ...
          <Grid item xs={12}>
            ...
            >
              <CardContent>
                ...
                <TextField
                  label="Enter permission name to delete"
                  variant="outlined"
                  fullWidth
                  sx={{ marginBottom: 2 }}
                  value={deletePermissionName}
                  onChange={(e) => setDeletePermissionName(e.target.value)}
                />
                <Button
                  variant="contained"
                  color="primary"
