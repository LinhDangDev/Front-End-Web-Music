              ...
              {group.map((item) => (
                <div className="card-playing-horizontal" key={item.songId}>
                  <figure className="card-playing-horizontal-header">
                    ...
                    >
                      <source
                        src={`http://localhost:8080/music/${item.filePath}`}
                        type="audio/mp3"
                      />
                  ...
                  <div className="card-playing-horizontal-body">
                    <h4>
                      <Link to={`/songs/${item.songId}/play`}>
                        {item.songTitle}
                      </Link>
                    </h4>
                    <p>
                      <Link
                        to={`/artist/${item.artistSongs[0].artist.artistId}/songs`}
                      >
                  ...
                  <div className="card-playing-horizontal-footer">
                    <a title="Like" aria-label="Like">
                      <span
                        id={`like${item.songId}`}
                        className="far fa-heart"
                        onClick={() => this.handleOnClickLike(item.songId)}
                      ></span>
                    </a>
                    <a
