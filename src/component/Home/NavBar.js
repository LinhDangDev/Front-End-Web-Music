...
<nav id="navbarFixed">
    <ul>
    <a href="javascript:void(0)" onClick={navbarMobileToggle} title="Menu" aria-label="Menu" className="fa-bars-mobile">
        <span className="far fa-bars"></span>
    </a>
    <a href="index.html">
        <img src="images/logo/SVG/Audiospark_Logo_Icon.svg" alt="" title="Audiospark" />
    </a>
