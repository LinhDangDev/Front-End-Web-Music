...
const NavBar = () => {
    ...
    <nav id="navbarFixed">
        ...
        <ul id="navbarMobileToggle" className={isMobileMenuOpen ? 'open' : ''}> {/* Apply "open" class based on state */}
            ...
            <li>
            <a href="localhost:3000/#explore">Explore</a>
            </li>
            <li>
            <a href="localhost:3000/#featured_creators">Featured Creators</a>
            </li>
            <li>
            <a href="localhost:3000/#trending">Trending</a>
            </li>
            <li>
            <a href="localhost:3000/#category">Category</a>
            </li>
            <li>
            <a href="localhost:3000/#popular_artists">Popular Artists</a>
            </li>
        </ul>
        </ul>
        <ul>
