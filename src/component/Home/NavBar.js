...
const NavBar = () => {
  ...
  function avatarDropdown() {
    document
      ...
      .classList.toggle("avatarDropdown");
  }
  ...
  return (
    <nav id="navbarFixed">
      <ul>
        ...
        <ul id="navbarMobileToggle" className={isMobileMenuOpen ? "open" : ""}>
          {" "}
          ...
          <li>
            <a href="http://localhost:3000/#featured_creators">
              Featured Creators
            </a>
          </li>
          <li>
      ...
      <ul>
        ...
        {/* AVATAR DORPDOWN */}
        <div
          className={`avatar-dropdown ${isAvatarDropdownOpen ? "open" : ""}`}
          id="avatarDropdown"
        >
          {" "}
          {/* Apply "open" class based on state */}
